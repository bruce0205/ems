...
module.exports = (app, db) => {
  ...
  router.get('/api/data/snapshot', async function (req, res, next) {
    const data = await db.query(`
      select m.mah_num,m.mah_pn,m.mah_mold, mah_sta,s.status_oee as status,m.remark as mah_remark ,m.Availability,m.Performance,m.Quality,pn.maf_tryd, m.ErrorList
